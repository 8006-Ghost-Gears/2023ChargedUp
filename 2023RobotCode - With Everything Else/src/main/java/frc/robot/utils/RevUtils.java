...
public final class RevUtils {
  ...
  public static void setDriveMotorConfig(CANSparkMax motorController) {
    motorController.getPIDController().setFF(0.075, PID_SLOT.VEL_SLOT.ordinal());//0.075  if you want to go fast set to 0.215 Will drain battery
    motorController.getPIDController().setP(0.125, PID_SLOT.VEL_SLOT.ordinal());//0.075 if you want to go fast set to 0.2 Will drain battery
